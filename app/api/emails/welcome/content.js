  ...
  <body style="word-spacing:normal;background-color:#f0f1f3;">
    ...
    <!-- Logo Header -->
      ...
      >
        ...
        <a
           href="https://www.presidentialsummary.com" target="_blank"
        >
          
      <img
         alt="" height="auto" src="https://www.presidentialsummary.com/logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150"
      />
      ...
      ><p style="
              ...
              line-height: 1.4;
              margin-top:2px;
            ">The President of the United States receives a top-secret briefing on the most important news of the day.</p>
          <p style="
              font-size: 16px;
              line-height: 1.4;
            ">Now, so will you.
    ...
    <!-- Spotlight -->
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:2px 12px 0px 12px;word-break:break-word;"
                >
    ...
    <!-- Spotlight contents --><!-- Content sections -->
      ...
      >&#8202;</div>
            ...
            <!-- Main Instructions -->
              <tr>
                <td
                   align="left" style="font-size:0px;padding:10px 20px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Roboto+Serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><p style="font-size: 20px; font-weight:300px; line-height: 1.4;">Hello and a big welcome to the Presidential family.</p>
          <!-- <p style="font-size: 21px; font-weight:300px; line-height: 1.4;">Hello and a big welcome to the Presidential family.</p> --></div>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 20px 10px 20px;word-break:break-word;"
                >
      ...
      <img
         alt="gif not there" height="auto" src="https://www.presidentialsummary.com/email/images/gif.gif" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="560"
      />
      ...
      <div
         style="font-family:Roboto+Serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><p style="font-size: 16px; font-weight:300px; line-height: 1.4;">If you want to read what these guys ☝️ read, tap on the button below to
        <span style="font-weight:bold;color:#4D3060;">VERIFY</span> your email and start getting your daily dose of quick, unbiased, fact checked news.
        </p></div>
    ...
    <!-- footer -->
      ...
      ><p style="
              ...
              font-size:12px;
              line-height: 2;
            "> Send us your feedback at <a style="text-decoration: none; border-bottom: 2px solid  #4D3060; color: black;" href="mailto:readers@presidentialsummary.com" target="_blank">readers@presidentialsummary.com</a>. </p>
          <p style="
              color:#000;
              font-size:12px;
              line-height: 2; 
            "> Interested in connecting with curious, informed readers? <a style="text-decoration: none; border-bottom: 2px solid  #4D3060; color: black;" href="https://www.presidentialsummary.com/advertise#advertise-form" target="_blank">Advertise with us</a>.</p>
            <!-- <p style="
              color:#000;
              font-size:12px;   
              line-height: 2;
            ">This is a paid advertisement for Upscale Media on behalf of Applied Nutrition. This is not medical advice. Always consult a healthcare professional before starting any treatments.</p> -->
          <p style="
              color:#000;
              font-size:12px;   
              line-height: 2;
            ">
            <a style="text-decoration: none; border-bottom: 2px solid  #4D3060; color: black;" href="https://www.presidentialsummary.com/unsubscribe?uniqueid=%unique-id%&email_uniqueid=%email_uniqueid%" target="_blank">Unsubscribe</a> from this email.
          </p></div>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href=" https://www.facebook.com/profile.php?id=61562652791256" target="_blank">
                    <img
                       height="24" src="https://www.presidentialsummary.com/icons/social/facebook.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href=" https://x.com/presidentialsum" target="_blank">
                    <img
                       height="24" src="https://www.presidentialsummary.com/icons/social/x.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.instagram.com/presidentialsummary/" target="_blank">
                    <img
                       height="24" src="https://www.presidentialsummary.com/icons/social/instagram.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.linkedin.com/showcase/presidentialsummary/" target="_blank">
                    <img
                       height="24" src="https://www.presidentialsummary.com/icons/social/linkedin.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.threads.net/@presidentialsummary" target="_blank">
                    <img
                       height="24" src="https://www.presidentialsummary.com/icons/social/threads.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
